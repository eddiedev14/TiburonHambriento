...
//Arrays Palabras
const palabras = ['velocidad-resultante'];
...
{//Llamamos al valor que hay dentro del input
	...
	else if (letra == "!" || letra == "¡" || letra == "#" || letra == "%" || letra == "&" || letra == "/" || letra == "(" || letra == ")" || letra == "=" || letra == "'" || letra == "?" || letra == "¿" || letra == "*" || letra == "-" || letra == "+" || letra == "´" || letra == "¨" || letra == "@" || letra == "|" || letra == "°" || letra == "{" || letra == "}" || letra == "[" || letra == "]" || letra == "," || letra == ";" || letra == "." || letra == ":" || letra == "_" || letra == "<" || letra == ">") {

...
document.querySelector('#calcular').addEventListener('click', () =>{
	...
	if (centimetroysegundo == '5') {
		r = n1 / 100000;
		document.querySelector('#r').innerHTML = "La respuesta es: " + r + " km/s";
	}
})
...
document.querySelector('#calcular2').addEventListener('click', () =>{
	...
	if (centimetroyhora == '9') {
		j = n2 / 3.6;
		document.querySelector('#j').innerHTML = "La respuesta es: " + j + " km/s";
	}
})
...
document.querySelector('#calcular3').addEventListener('click', () =>{
	...
	if (metroysegundo == '12') {
		k = n3 / 1000;
		document.querySelector('#k').innerHTML = "La respuesta es: " + k + " km/s";
	}
})
let metroyhora = '13';
document.querySelector('#calcular4').addEventListener('click', () =>{
	...
	if (metroyhora == '13') {
		ñ = n4 / 3.6;
		document.querySelector('#ñ').innerHTML = "La respuesta es: " + ñ + " km/s";
	}
})
...
document.querySelector('#calcular5').addEventListener('click', () =>{
	...
	if (kilometroyhora == '15') {
		s = n5 / 3600;
		document.querySelector('#s').innerHTML = "La respuesta es: " + s + " km/s";
	}
})
/*let op;
